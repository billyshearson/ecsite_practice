...
class GoodsCategory(models.Model):
    ...
    name = models.CharField(default="", max_length=50,
                            verbose_name="カテゴリー名", help_text="カテゴリー名")
    code = models.CharField(default="", max_length=30,
                            verbose_name="カテゴリーコード", help_text="カテゴリーコード")
    desc = models.TextField(
        default="", verbose_name="カテゴリー説明", help_text="カテゴリー説明")
    category_type = models.IntegerField(
        choices=CATEGORY_TYPE, verbose_name="カテゴリーレベル", help_text="カテゴリーレベル")
    ...
    is_tab = models.BooleanField(
        default=False, verbose_name="ナビなのか", help_text="ナビなのか")
...
class GoodsCategoryBrand(models.Model):
    ...
    name = models.CharField(default="", max_length=30,
                            verbose_name="ブランド名", help_text="ブランド名")
    desc = models.CharField(default="", max_length=200,
                            verbose_name="ブランド説明", help_text="ブランド説明")
...
class Goods(models.Model):
    ...
    goods_sn = models.CharField(
        max_length=50, default="", verbose_name="商品識別番号")
...
class GoodsImage(models.Model):
    ...
    image = models.ImageField(
        upload_to="", verbose_name="画像", null=True, blank=True)
    add_time = models.DateTimeField(default=datetime.now, verbose_name="挿入時間")
...
class Banner(models.Model):
    ...
    image = models.ImageField(
        upload_to="banner", verbose_name="ホームページswiper用画像")
...
class IndexAd(models.Model):
    ...
    goods = models.ForeignKey(
        Goods, related_name='goods', on_delete=models.CASCADE)
...
class HotSearchWords(models.Model):
    ...
    keywords = models.CharField(
        default="", max_length=20, verbose_name="人気キーワード")
